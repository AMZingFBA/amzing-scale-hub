...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border ${isNativeApp ? 'pt-safe-navbar' : ''}`}>
      <div className="container mx-auto px-4">
        <div className={`flex items-center justify-between ${isNativeApp ? 'h-16' : 'h-20'}`}>
