...
const getCategoryRoute = (category: string, subcategory: string | null) => {
  ...
  if (category === 'produits') {
    const productRoutes: Record<string, string> = {
      ...
      'produits-auchan': '/produits-auchan',
      'produits-leclerc': '/notification-alerts',
      'produits-carrefour': '/notification-alerts',
      'produits-smythstoys': '/notification-alerts',
      'produits-miamland': '/notification-alerts',
      'produits-stokomani': '/notification-alerts',
      'produits-qogita2': '/notification-alerts',
