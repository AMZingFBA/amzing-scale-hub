            ...
            <div className="max-w-4xl mx-auto">
              ...
              <Card className="bg-gradient-to-r from-primary to-secondary text-white border-none">
                <CardContent className="py-8 text-center">
                  <h3 className="text-xl font-bold mb-3">Tu veux gagner du temps ?</h3>
                  <p className="text-white/90 mb-6 max-w-xl mx-auto">
                    AMZing FBA t'envoie chaque jour des produits rentables déjà analysés. Plus besoin de chercher pendant des heures.
                  </p>
              ...
              <Card className="bg-gradient-to-r from-primary to-secondary text-white border-none">
                <CardContent className="py-10 text-center">
                  ...
                  <p className="text-white/90 mb-6 max-w-2xl mx-auto">
                    Rejoins AMZing FBA et reçois chaque jour des opportunités de produits rentables analysés pour toi. Formation, outils et communauté inclus.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Button size="lg" variant="secondary" asChild className="text-lg px-8">
                      <Link to="/tarifs">
                        Recevoir des opportunités prêtes à vendre
                        <ArrowRight className="w-5 h-5 ml-2" />
                      </Link>
                    </Button>
                  </div>
