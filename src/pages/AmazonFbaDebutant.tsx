import { ArrowRight, ArrowLeft, CheckCircle2, AlertTriangle, Users, BookOpen, Target, Lightbulb, TrendingUp, ShoppingCart, Package } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO 
        ...
        schema={schemas.amazonFbaDebutantArticle}
      />
      <Navbar />
