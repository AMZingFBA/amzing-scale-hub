...
const Annonces = () => {
  ...
  useMarkAsRead({ category: 'informations', subcategory: 'annonces' });
    ...
    if (isVIP) {
      ...
      const alertsChannel = supabase
        ...
        .on(
          ...
          (payload) => {
            if (payload.new.category === 'informations' && payload.new.subcategory === 'annonces') {
              toast({
