            ...
            <div className="not-prose">
              <Card className="bg-gradient-to-br from-green-500/10 to-primary/10 border-green-500/30">
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mt-3"><span className="line-through">700€</span> <span className="text-red-500 font-semibold">500€/an TTC</span> <span className="bg-red-500/20 text-red-500 text-xs px-2 py-0.5 rounded">🔥 OFFRE FLASH</span> • Accès 12 mois</p>
                </CardContent>
              </Card>
            </div>
