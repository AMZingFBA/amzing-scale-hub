                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>• Chaque filleul souscrit à l'abonnement annuel (700€/mois ou ~64€/mois × 12)</li>
                      <li>• Le paiement est effectué dès son inscription</li>
                      <li>• Tu reçois une commission sur chaque vente</li>
