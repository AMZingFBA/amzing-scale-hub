-- Mettre à jour la fonction trigger pour inclure le téléphone
...
BEGIN
  ...
  ELSIF TG_TABLE_NAME = 'subscriptions' THEN
    ...
    SELECT p.email, COALESCE(p.full_name, ''), COALESCE(p.phone, '')
  ...
  -- Build request body with phone included
  ...
  -- Make async HTTP call using pg_net extension
