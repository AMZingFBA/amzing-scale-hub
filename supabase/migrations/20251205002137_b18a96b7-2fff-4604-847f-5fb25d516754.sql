...
ADD COLUMN IF NOT EXISTS registration_source text DEFAULT 'site';

-- Update the handle_new_user function to capture registration_source from user metadata
...
BEGIN
  -- Insert profile with nickname and registration_source
  INSERT INTO public.profiles (id, email, full_name, nickname, registration_source)
  VALUES (
    NEW.id,
    NEW.email,
